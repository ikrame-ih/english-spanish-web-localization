...
description: Plan, execute, audit, and QA contextual website and digital-product localization among British English (en-GB), US English (en-US), Spanish for Spain (es-ES), and Latin American Spanish (es-419). Use for repositories, locale catalogs, CMS exports, UI copy, marketing, SEO, accessibility, CVs, and terminology systems; not for certified translation.
---
